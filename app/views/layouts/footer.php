<footer class="footer mt-auto py-4 bg-light">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <h5>Sobre Next Gen System</h5>
                <p class="text-muted">
                    Next Gen System es una empresa dedicada a ofrecer soluciones contables eficientes y efectivas, adaptadas a las necesidades de nuestros clientes.
                </p>
            </div>
        ...
        <div class="text-center mt-3">
            <span class="text-muted">&copy; 2024 Soluciones Contables, Next Gen System.</span>
        </div>
    </div>
</footer>
